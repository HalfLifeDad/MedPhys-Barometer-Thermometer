...
# Adapted by Bryan Jackson from the DFRobot library
import time
from math import pow
import sys
class DFRobot_BMP390:
  def __init__(self):
    self.op_mode = 0
    self.par_t1 = 0
    self.par_t2 = 0
  ...
  def parse_calib_data(self,calib): # Parse
    ...
    #self.par_p1 = (((calibTempA<<8)|calibTempB)-16384)/temp_var
    self.par_p1 = (((calib[6]<<8)|calib[5])-16384)/temp_var
    ...
    self.par_p2 = (((calib[8]<<8)|calib[7])-16384)/temp_var
    #print((calibTempA<<8)|calibTempB)
  ...
  def compensate_pressure(self,uncomp_pressure,t_lin):
    ...
    partial_out2 = uncomp_pressure *(self.par_p1 + partial_data1 + partial_data2 + partial_data3)
...
class DFRobot_BMP390_SPI(DFRobot_BMP390):
  def __init__(self,spi,cs):
    self.spi = spi
    self.cs = cs    
    super(DFRobot_BMP390_SPI,self).__init__()
...
class DFRobot_BMP390_I2C(DFRobot_BMP390):
  def __init__(self,i2c):
    self.i2c = i2c
    super(DFRobot_BMP390_I2C,self).__init__()
